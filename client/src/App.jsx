...
export default function App() {
  ...
  // Use deployed backend URL for production, fallback to localhost in dev
  const serverUrl =
    import.meta.env.VITE_SERVER_URL ||
    "https://your-backend-service.onrender.com";

  // Configure Socket.io with CORS + credentials + secure connection
    ...
    (async () => {
      try {
        const res = await axios.get(
          `${serverUrl}/api/messages?room=${encodeURIComponent(room)}&limit=50`,
          { withCredentials: true }
        );
